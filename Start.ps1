...
# # This section can be used to pull the latest agent every time the container starts but is very slow
# # We've just loaded an agent in the Dockerfile instead.
# $useragent = 'wincore-oe-vsts'
